        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                ...
                <li class="nav-item"><a href="{{ route('logout') }}"
                                    ...
                                    document.getElementById('logout-form').submit();" class="nav-link"><span class="pcoded-micon"><i class="far fa-sign-out-alt"></i></span><span class="pcoded-mtext">Logout</span>
